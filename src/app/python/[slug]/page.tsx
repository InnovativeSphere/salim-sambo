// ============================================================
// src/app/python/[slug]/page.tsx
// Full project detail page — used by all stacks
// ============================================================
...
// ─────────────────────────────────────────────
// ONLY CHANGE THESE TWO LINES FOR OTHER STACKS:
//   frontend → "frontend" / "Frontend"
//   backend  → "backend"  / "Backend"
//   mobile   → "mobile"   / "Mobile"
// ─────────────────────────────────────────────
const STACK_SLUG = "python" as const;
const STACK_LABEL = "Python & AI";
...
export default async function ProjectPage({
  ...
  // Index of current project within siblings
